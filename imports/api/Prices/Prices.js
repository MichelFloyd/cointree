...
Prices.schema = new SimpleSchema({
  ...
  volume_usd_24h: { type: Number, label: '24h volume in USD', optional: true },
  ...
  max_supply: { type: Number, label: 'Maximum supply', optional: true },
  percent_change_1h: { type: Number, label: 'Percent change 1h', optional: true },
  percent_change_24h: { type: Number, label: 'Percent change 24h', optional: true },
  percent_change_7d: { type: Number, label: 'Percent change 7d', optional: true },
